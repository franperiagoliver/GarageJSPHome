    	...
    	<nav id="colorNav">
			<ul>
				<li class="green">
					...
					<ul>
						<li><a href="/GarageJSP/dispatcher?option=1">Listar plazas libres</a></li>
						<li><a href="/GarageJSP/dispatcher?option=2">Listar plazas ocupadas</a></li>
						<li><a href="/GarageJSP/dispatcher?option=3">Reservar plazas</a></li>
						<li><a href="/GarageJSP/dispatcher?option=4">Listar clientes</a></li>
						<li><a href="/GarageJSP/dispatcher?option=5">Listar reservas</a></li>
						<li><a href="/GarageJSP/dispatcher?option=6">Listar vehículos</a></li>
						<li><a href="/GarageJSP/dispatcher?option=7">Filtrar reservas por fecha</a></li>
					</ul>
				</li>
				<li class="red">
